        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if (\Illuminate\Support\Facades\Route::currentRouteName() == 'dashboard') active @endif" aria-current="page"
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if (\Illuminate\Support\Facades\Route::getCurrentRoute()->getPrefix() == '/undangan') active @endif" aria-current="page"
                            href="{{ route('undangan') }}">
                            <i class="icon">
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if (\Illuminate\Support\Facades\Route::getCurrentRoute()->getPrefix() == '/user') active @endif" aria-current="page"
                            href="{{ route('user') }}">
                            <i class="icon">
                                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                        ...
                        <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown"
                                    ...
                                    <img src="{{ asset('admin/images/avatars/default.jpg') }}" alt="User-Profile"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="flex-wrap d-flex justify-content-between align-items-center">
                                <div>
                                    <h1>Halo {{ auth()->user()->nickname }}!</h1>
                                    <p>Selamat datang di halaman dashboard undangan online.</p>
                                </div>
                                <div>
